...
import { component_starter, context_code, provider_code, style_starter } from '../../../assets/constants/reactNative';
...
const StartingWithReactNative = () => {
    return (
        <section>
            ...
            <Text>Install XCode and ios simulator along with it</Text>
            ...
            <Text>A context api is high level state management. 
                ...
                How is it different from maintaining state at the app level? If you maintain a local state in App.js then you have to pass it down to every component that needs it.
                But with context API the props need not be passed. All the components which are children to the context will have access to the state via useContext hook.
            </Text>
            ...
            <Text>Here, we are creating two state variables which we think will be used across the app repeatedly. 
                Hence we will store that in the GlobalContext, the provider returns the children which are enclosed in that tag</Text>
