	...
	return (
		<section>
			...
			<CodeSnippet code={`db.potentialContacts.insert({
					...
					message: "Hi, You have a good experience in product development, I am currently looking for a person to lead a project, would be interested to discuss this opportunity."
				});
			`} />
			So suppose you havent handled the form validation on the frontend, in case of SQL the database will throw an error saying some fields are missing, but in case of NOSQL you dont have to worry about that.
			...
			What if we want to retain the exisiting fields and change only certain fields in the record.
			...
			<CodeSnippet code={`db.potentialContacts.insert([
				...
				},
				{
					...
					message: "I am a undergraduate student, I would like to apply for a job opening at your company, could you refer for the same?"
				},
				{
					name: "Jhonny",
